...
TitleUnderline.Position = UDim2.new(0.499412417, 0, -0.0130906757, 0)


TitleUnderline.Size = UDim2.new(0, 125, 0.0199999996, 0)
...
local function WWGRU_fake_script() -- Top.Handler 
...
coroutine.wrap(WWGRU_fake_script)()


local function IQCKY_fake_script() -- Top.Drag 
...
coroutine.wrap(IQCKY_fake_script)()


local function YIMO_fake_script() -- Loader.Loadthing 
...
coroutine.wrap(YIMO_fake_script)()
