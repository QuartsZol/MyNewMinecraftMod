...
local function ZWTI_fake_script() -- Top.Handler 
	...
	auth.MouseButton1Click:Connect(function()
		...
		if keytxt.Text == key then
			...
			loadbar:TweenSize(UDim2.new(0.2, 0,1.0, 0),'Out','Sine',1)
			...
			loadbar:TweenSize(UDim2.new(0.65, 0,1.0, 0),'Out','Sine',1)
			...
			loadbar:TweenSize(UDim2.new(0.85, 0,1.0, 0),'Out','Sine',1)
